  ...
  return (
    <div className="bg-black w-screen h-screen relative overflow-y-scroll overflow-x-hidden">
      <div className="flex gap-4 w-full px-2">
        <div className="flex flex-col mt-[10%] ml-4">
          ...
          <div className="flex gap-1">
            <p className="text-orange-500 text-2xl font-bold">DELIVERY</p>
            <span className="text-white text-3xl font-bold">&</span>
          </div>
          <div className="flex gap-1">
            <p className="text-2xl font-bold text-white">EASY</p>
            <p className="text-2xl font-bold text-orange-500">PICKUP</p>
          </div>
      ...
      <div className="flex gap-2">
        ...
        <div className="bg-orange-500 rounded-xl w-44 h-8 mt-8">
          <div className="flex gap-1">
            <Search size={20} className="text-white mt-2 -translate-y-0.5 ml-1" />
            <input className="text-white text-xs mt-1.5 underline underline-offset-2" type="text" placeholder="Enter Item or Restaurant" onClick={handleSearchClick} />
          </div>
        </div>
      </div>
