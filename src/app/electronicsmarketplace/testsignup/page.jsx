    ...
    return(
        <div className="w-screen min-h-screen flex justify-center">
            <div className="max-w-md w-full bg-white relative overflow-hidden flex">
                ...
                <h2 className="text-white text-4xl font-bold absolute top-34 w-full flex justify-center px-20 text-center">Create Your Account</h2>
                <form  className="max-w-md w-full z-30 flex flex-col justify-center items-center gap-5 mt-40">
