...
import { Smile, Trash2, Send } from "lucide-react";
import { useChat } from "../context/chatContext";
import Image from "next/image";

const ChatInterface = ({ onClose, productId, variantId, inventoryId,productImage,productName,productDescription,productSeller }) => {
  ...
  return (
       <motion.div
      className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-black/40 z-50 p-4"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    ...
    >
      <motion.div
        className="w-full bg-white/90 backdrop-blur-md rounded-2xl shadow-xl border border-gray-100/50 overflow-hidden"
      ...
      >
       <div className="bg-white/95 p-4 border-b border-gray-100/50 flex flex-col space-y-3">
        ...
        <div className="p-4 bg-white/95 border-t border-gray-100/50">
          ...
          {showOffer && (
            <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-black/40 flex items-center justify-center z-60 p-4">
              <div className="w-full bg-white/90 backdrop-blur-md rounded-2xl shadow-xl border border-gray-100/50 p-4">
                <div className="flex items-center justify-between">
