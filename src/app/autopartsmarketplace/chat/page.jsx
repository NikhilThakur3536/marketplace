      ...
      <div className="flex flex-col gap-4 max-w-md w-full bg-[#0F172B]">
        ...
        <div className="w-full px-4 flex gap-4 py-3 items-center bg-[#1C283C] shadow-md sticky top-0 z-50">
          <ChevronLeft
            ...
            onClick={() => router.push("/autopartsmarketplace")}
          />
          <span className="font-bold text-xl text-white">Chats</span>
        </div>
        ...
        <div className="flex flex-col gap-2 px-4">
          ...
          {chats.map((chat) => (
            <div
              key={chat.id}
              className="flex items-center gap-3 p-3 bg-[#1C283C] rounded-lg shadow-md cursor-pointer transition-colors"
