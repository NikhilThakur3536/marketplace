      ...
      <div className="w-full max-w-md h-full relative ">
        ...
        <div className="flex justify-between">
          ...
          <input
            type="text"
            defaultValue="Dubai"
            className="fixed left-[55%] top-1 z-50 w-[40%] px-8 py-1 bg-orange-500 rounded-md text-white font-semibold shadow-lg transform -translate-y-0.5 placeholder:text-xs placeholder:-top-0.5"
        ...
        <motion.div
          className="absolute bg-white h-[18%] w-[23%] rounded-t-xl bottom-[32.3%] left-[9%] flex flex-col items-center md:bottom-[38.3%] "
        ...
        >
          ...
          <motion.div
            className="bg-green-500 w-fit h-fit rounded-full p-1 absolute bottom-1 left-1"
            initial={{ opacity: 0, scale: 0 }}
            animate={{ opacity: 1, scale: 1 }}
        ...
        <motion.div
          className="absolute bg-white h-[20%] w-[23%] rounded-t-xl bottom-[32.3%] left-[38%] flex flex-col items-center md:bottom-[38.3%]"
          initial={{ height: 0, opacity: 0 }}
        ...
        <motion.div
          className="absolute bg-white h-[22%] w-[23%] rounded-t-xl bottom-[32.3%] left-[70%] flex flex-col items-center md:bottom-[38.3%]"
          initial={{ height: 0, opacity: 0 }}
        ...
        <div className="flex gap-20 ml-12  relative ">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.4, delay: 0.3 }}
            className="absolute top-[12%] left-56 transform translate-x-1"
          >
            <Image
              src="/chowmein.png"
              alt="chowmein"
        ...
        <div className="w-full h-[80vh] px-2 flex flex-col items-center gap-2 mt-4">
          ...
          <div className="bg-gradient-to-b from-[#4D906E] to-[#0BAE5B] rounded-lg w-[80%] h-[50%] border-2 border-[#004D26] relative">
            ...
            <p className="bg-yellow-400 w-fit p-1 rounded-lg font-bold text-white -rotate-30 ml-4 -mt-12 text-2xl">Rs.250</p>
          </div>
          <div className="bg-[#FC603A] rounded-lg w-[80%] h-[50%] border-4 border-[#BC2F0C] relative">
            ...
            <div className="rounded-full w-16 h-16 bg-green-500 border-4 border-[#117D47] absolute right-2 top-2 text-white font-bold flex justify-center items-center">Rs 230</div>
          </div>
        </div>
        <div className="mt-12 flex gap-16">
        ...
        <div className="w-full h-[100vh] px-2 flex flex-col items-center gap-2 mt-4">
          <div className="relative bg-green-500 rounded-lg w-[80%] h-[50%] border-4 border-[#037932]">
