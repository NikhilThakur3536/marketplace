...
import ComputerBot from '../computerchatbot/page';
...
export default function MobileView() {
 ...
 const textSets = [
    { line1: "SMART TECH", line2: "SPEED", line3: "RETRIEVAL" },
    { line1: "QUICK DISPATCH", line2: "DELIVERIES", line3: "PICKUP" },
    { line1: "RAPID SERVICE", line2: "DROP-OFF", line3: "CONVENIENCE" },
    { line1: "TECH-SAVVY", line2: "DELIVERIES", line3: "COLLECT" },
];
    ...
    <div className="bg-black w-screen h-screen relative overflow-y-auto  flex justify-center">
      ...
      <div className="max-w-md h-full relative ">
          ...
          <div className="bg-orange-500 rounded-xl w-[80%] h-8 mt-8">
            <div className="flex gap-1">
              ...
              <input
                ...
                type="text"
                placeholder="Enter Item or Restaurant"
        ...
        >
          ...
          >
            <Image src="/headphone.png" alt="biryani" width={50} height={50} />
          </motion.div>
          <motion.div
        ...
        >
          ...
          <motion.div
            ...
            transition={{ duration: 0.3, delay: 0.6 }}
          >
            <Image src="/mobile.png" alt="burger" width={60} height={60} />
          </motion.div>
          <motion.div
            className="bg-green w-fit h-fit rounded-full p-1 absolute bottom-1 left-1"
            initial={{ opacity: 0, scale: 0 }}
        ...
        >
          ...
          <motion.div
            ...
            transition={{ duration: 0.3, delay: 0.7 }}
          >
            <Image src="/laptop.png" alt="breads" width={90} height={90} />
          </motion.div>
          <motion.div
            className="bg-green w-fit h-fit rounded-full p-1 absolute bottom-1 left-1"
            initial={{ opacity: 0, scale: 0 }}
        ...
        <div className="flex gap-20 ml-12  relative ">
          ...
          <p className="absolute -bottom-6 left-4 text-white font-bold text-lg">Computer</p>
          ...
          <motion.div
            ...
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.4, delay: 0.3 }}
            className="absolute top-[15%] left-52 transform translate-x-1"
          >
            <Image
              src="/headphone.png"
              alt="chowmein"
          ...
          <p className="absolute -bottom-6 left-[61%] text-white font-bold text-lg">Headphones</p>
        ...
        <div className="flex w-full justify-center -ml-2 mt-6 relative">
          ...
          <p className="absolute -bottom-6 left-[41%] text-white font-bold text-lg">Mobiles</p>
        ...
        <div className="w-full h-[80vh] px-2 flex flex-col items-center gap-2 mt-4">
          <div className="relative bg-gradient-to-b from-[#FFCF54] to-[#C28E07] rounded-lg w-[80%] h-[50%] border-2 border-[#E4A80F] flex flex-col px-2">
            ...
            <Image src="/headphone.png" alt="burger" width={160} height={160} className="absolute right-1 top-6" />
          ...
          <div className="bg-gradient-to-b from-[#4D906E] to-[#0BAE5B] rounded-lg w-[80%] h-[50%] border-2 border-[#004D26] relative">
            <Image src="/laptop.png" width={230} height={230} alt="chicken biryani" className="absolute bottom-0 left-12" />
          ...
          <div className="bg-[#FC603A] rounded-lg w-[80%] h-[50%] border-4 border-[#BC2F0C] relative">
            <Image src="/mobile.png" width={120} height={120} alt="veg chowmein" className="absolute bottom-0 left-24" />
        ...
        <div className="w-full h-[100vh] px-2 flex flex-col items-center gap-2 mt-4">
          <div className="relative bg-green rounded-lg w-[80%] h-[50%] border-4 border-[#037932]">
            <div className="w-full h-[50%] relative">
              <Image src="/laptop.png" alt="restaurant cover" fill className="object-fill ml-8" />
            </div>
            ...
            <p className="bg-yellow-400 text-green-500 font-bold text-sm w-fit h-fit px-2 py-0.5 rounded-xl ml-8">Extra 10% off on First Order</p>
